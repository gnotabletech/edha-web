...
class MemberInfo(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        self.public_image = f'profile/{self.constituency}_public.jpg'.replace(' ', '_').lower()
        self.profile_image = f'profile/{self.constituency}_profile.jpg'.replace(' ', '_').lower()
        self.cover_image = f'profile/{self.constituency}_cover.jpg'.replace(' ', '_').lower()
